 ...
 */
class Admin extends \Lifestutor\StoreBundle\Document\Admin implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'userType', 'id', 'username', 'password', 'firstname', 'lastname');
        }
