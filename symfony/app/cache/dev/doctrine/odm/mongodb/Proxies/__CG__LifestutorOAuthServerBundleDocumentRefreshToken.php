 ...
 */
class RefreshToken extends \Lifestutor\OAuthServerBundle\Document\RefreshToken implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'client', 'token', 'expiresAt', 'scope', 'user');
        }
