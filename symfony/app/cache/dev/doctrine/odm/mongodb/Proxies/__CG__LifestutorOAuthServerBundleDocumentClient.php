 ...
 */
class Client extends \Lifestutor\OAuthServerBundle\Document\Client implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'randomId', 'secret', 'redirectUris', 'allowedGrantTypes');
        }
