...
class appDevDebugProjectContainer extends Container
{
    ...
    /**
     * Gets the 'apikey_user_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Lifestutor\StoreBundle\Security\ApiKeyUserProvider A Lifestutor\StoreBundle\Security\ApiKeyUserProvider instance.
     */
    ...
    protected function getDoctrineMongodb_Odm_DefaultConfigurationService()
    {
        ...
        $b->setNamespace('sf2mongodb_default_dce471256066534dba28f31e06069e6b659d35ce0582b60e997414256a595bd4');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \FOS\OAuthServerBundle\Document\AccessTokenManager A FOS\OAuthServerBundle\Document\AccessTokenManager instance.
     */
     ...
     * This method always returns the same instance of the service.
     *
     * @return \FOS\OAuthServerBundle\Document\AuthCodeManager A FOS\OAuthServerBundle\Document\AuthCodeManager instance.
     */
     ...
     * This method always returns the same instance of the service.
     *
     * @return \FOS\OAuthServerBundle\Document\ClientManager A FOS\OAuthServerBundle\Document\ClientManager instance.
     */
     ...
     * This method always returns the same instance of the service.
     *
     * @return \FOS\OAuthServerBundle\Document\RefreshTokenManager A FOS\OAuthServerBundle\Document\RefreshTokenManager instance.
     */
    ...
    /**
     * Gets the 'kernel.listener.cors_response_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Lifestutor\StoreBundle\EventListener\CorsResponseListener A Lifestutor\StoreBundle\EventListener\CorsResponseListener instance.
     */
    ...
    /**
     * Gets the 'lifestutor_store.customer.service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Lifestutor\StoreBundle\Service\CustomerService A Lifestutor\StoreBundle\Service\CustomerService instance.
     */
    ...
    /**
     * Gets the 'lifestutor_store.user.service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Lifestutor\StoreBundle\Service\UserService A Lifestutor\StoreBundle\Service\UserService instance.
     */
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.oauth_token' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/oauth/v2/token'), 'security.firewall.map.context.api' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/.*'), 'security.firewall.map.context.default' => NULL)), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_ApiService()
    {
        ...
        return $this->services['security.firewall.map.context.api'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \FOS\OAuthServerBundle\Security\Firewall\OAuthListener($a, $b, $c), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '54fc134b7f95b', $d, $b), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'api', new \FOS\OAuthServerBundle\Security\EntryPoint\OAuthEntryPoint($c), NULL, NULL, $d));
    }
