 ...
 */
class AccessToken extends \Lifestutor\OAuthServerBundle\Document\AccessToken implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'client', 'user', 'token', 'expiresAt', 'scope');
        }
